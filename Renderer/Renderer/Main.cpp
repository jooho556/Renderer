...
int main(int /*argc*/, char** /*argv*/)
{
    ...
    std::vector<std::string> texture_paths = { "Textures/Container.png", "Textures/Container_specular.png" };
    Texture container(texture_paths);

    Shader lighting_shader("Shaders/PongShading.vs", "Shaders/PongShading.fs");
    Drawable object(vertices, 36, 8, &lighting_shader);
    object.SetTexture(&container);
